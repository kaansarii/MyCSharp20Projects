...
namespace Project12_JwtToken.JWT
{
    public class TokenGenerator
    {
        ...
        {
            var securityKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("20Derste20ProjeTok+-*/1234tokenJWT")); //imza diyebiliriz
            var credentials = new SigningCredentials(securityKey, SecurityAlgorithms.HmacSha256);       
            var claimsExample = new[]       //temel parametreleri tutuyor
            {
